...
angular.module('cartoview.mapViewerApp').directive('toggleButton', function(urlsHelper) {
  return {
    ...
    templateUrl: urlsHelper.static + "cartoview_collector/angular-templates/view/toggle-button.html",
    replace: true,
        ...
        link:function(scope, element){
            ...
            var showAboutDialog = function(ev) {
                ...
                $mdDialog.show({
                    ...
                    templateUrl: urlsHelper.static + "cartoview_collector/angular-templates/view/about-dialog.html",
...
angular.module('cartoview.mapViewerApp').directive('layersSwitcher',  function(urlsHelper) {
    return {
        ...
        transclude: true,
        replace: true,
        templateUrl: urlsHelper.static + "cartoview_collector/angular-templates/view/layers-switcher.html",
...
angular.module('cartoview.mapViewerApp').directive('layersLegend',  function(urlsHelper) {
    return {
        ...
        transclude: true,
        replace: true,
        templateUrl: urlsHelper.static + "cartoview_collector/angular-templates/view/layers-legend.html",
        controller: function ($scope, mapService){
            mapService.get().then(function(){
                $scope.overlays = mapService.map.overlays;
...
angular.module('cartoview.mapViewerApp').directive('basemapsSwitcher',  function(urlsHelper) {
    return {
        ...
        transclude: true,
        replace: true,
        templateUrl: urlsHelper.static + "cartoview_collector/angular-templates/view/basemaps-switcher.html",
...
angular.module('cartoview.mapViewerApp').directive('zoomBar',  function(urlsHelper) {
    return {
        ...
        transclude: true,
        replace: true,
        templateUrl: urlsHelper.static + "cartoview_collector/angular-templates/view/zoom-bar.html",
        controller: function ($scope, mapService) {
...
angular.module('cartoview.mapViewerApp').directive('rotationBar',  function(urlsHelper) {
    return {
        ...
        transclude: true,
        replace: true,
        templateUrl: urlsHelper.static + "cartoview_collector/angular-templates/view/rotation.html",
        controller: function ($scope, mapService) {
            $scope.rotation = 0;
            mapService.get().then(function () {
