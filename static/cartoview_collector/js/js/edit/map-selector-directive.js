...
angular.module('cartoview.viewer.editor').directive('mapSelector', function (urlsHelper) {
    return {
        ...
        transclude: true,
        replace: true,
        templateUrl: urlsHelper.static + "cartoview_collector/angular-templates/edit/map-selector.html",
        controller: function ($scope, dataService, $mdMedia, $mdDialog) {
            ...
            $scope.openMapsSelector = function (ev) {
                ...
                $mdDialog.show({
                    ...
                    templateUrl: urlsHelper.static + "cartoview_collector/angular-templates/edit/map-selector-dialog.html?aa",
